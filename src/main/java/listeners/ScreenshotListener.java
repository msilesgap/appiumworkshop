...
/**
 * Created by moises.siles on 11/28/2016.
 */
public class ScreenshotListener extends TestListenerAdapter {
    ...
    public void onTestFailure(ITestResult failingTest){
        try{
            WebDriver driver = ActionBot.getDriverInstance();
            //TODO find out why the screenshotDirectory property is not gotten from pom file
            //String screenshotDirectory = System.getProperty("screenshotDirectory");
            String screenshotDirectory = Const.SCREENSHOT_FOLDER_NAME;
            //String screenshotDirectory = System.getProperty("screenshotDirectory");
            ...
            ex.printStackTrace();
            //Review if the following command is not causing any issue during the test execution
            ActionBot.getDriverInstance().quit();
        }
    }
}
