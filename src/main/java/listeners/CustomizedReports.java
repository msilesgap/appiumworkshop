...
public class CustomizedReports implements IReporter {
    ...
    private String initReportTemplate() {
        ...
        byte[] reportTemplate;
        try {
            reportTemplate = Files.readAllBytes(Paths.get("src/main/resources/reportTemplate.html"));
    ...
    private void saveReportTemplate(String outputDirectory, String reportTemplate) {
        ...
        try {
            PrintWriter reportWriter = new PrintWriter(new BufferedWriter(new FileWriter(new File(outputDirectory, "eab-report.html"))));
